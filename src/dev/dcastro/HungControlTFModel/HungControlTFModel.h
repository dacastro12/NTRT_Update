...
#ifndef HungCONTROL_TF_MODEL_H
#define HungCONTROL_TF_MODEL_H

/**
 * @file HungControlTFModel.h
 ...
 */
class HungControlTFModel : public tgSubject<HungControlTFModel>, public tgModel
{
public:
