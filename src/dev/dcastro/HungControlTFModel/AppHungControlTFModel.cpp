...
/**
 * @file AppHungControlTFModel.cpp
...
{
    std::cout << "AppHungControlTFModelTest" << std::endl;
    ...
    HungControlTFController* const pTC = new HungControlTFController(5, timestep_physics, goalTrajectory);
