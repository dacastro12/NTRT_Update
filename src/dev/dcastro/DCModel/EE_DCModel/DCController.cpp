 ...
 * @brief Preferred Length Controller for DCModel
...
void DCController::onStep(DCModel& subject, double dt) {
...
void DCController::moveAllMotors(DCModel& subject, double dt) {
...
void DCController::updateActions(DCModel& subject, double dt) {
...
void DCController::applyActions(DCModel& subject, vector< vector <double> > act)
{
